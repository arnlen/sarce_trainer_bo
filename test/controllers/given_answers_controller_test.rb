...
class GivenAnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create given_answer" do
    assert_difference('GivenAnswer.count') do
      post given_answers_url, params: { given_answer: { answer: @given_answer.answer, is_correct: @given_answer.is_correct, question_id: @given_answer.question_id, user_id: @given_answer.user_id } }
    end

    assert_redirected_to given_answer_path(GivenAnswer.last)
  end
  ...
  test "should update given_answer" do
    patch given_answer_url(@given_answer), params: { given_answer: { answer: @given_answer.answer, is_correct: @given_answer.is_correct, question_id: @given_answer.question_id, user_id: @given_answer.user_id } }
    assert_redirected_to given_answer_path(@given_answer)
  end
