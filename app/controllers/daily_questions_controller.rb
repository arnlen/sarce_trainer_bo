class DailyQuestionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @daily_question.save
        ...
        format.json { render :show, status: :created, location: @daily_question }
      else
  ...
  def update
    respond_to do |format|
      if @daily_question.update(daily_question_params)
        ...
        format.json { render :show, status: :ok, location: @daily_question }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to daily_questions_url, notice: 'Daily question was successfully destroyed.' }
